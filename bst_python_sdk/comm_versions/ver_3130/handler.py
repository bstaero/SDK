...
packet_mapping = {
    ...
    PacketTypes.SYSTEM_BATTERY_STATE.value: BatteryState,
...
fw_mapping = {
    ...
    PacketTypes.STATE_ESTIMATOR_PARAM.value: fixedwing.EstimatorParameters,
...
mr_mapping = {
    ...
    PacketTypes.STATE_ESTIMATOR_PARAM.value: multicopter.EstimatorParameters,
