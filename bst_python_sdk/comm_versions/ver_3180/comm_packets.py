...
class TelemetrySystem:
	...
	batt_coulomb_count = 0, batt_percent = 0, flight_time = 0, week = 0,
	hour = 0, minute = 0, milliseconds = 0, satellites = 0, pdop = 0,
	...
	def parse(self,buf):
		...
		self.batt_coulomb_count = struct.unpack_from('<H',buf,offset)[0]
		offset = offset + struct.calcsize('<H')
	...
	def serialize(self):
		...
		buf.extend(struct.pack('<H', self.batt_coulomb_count))
