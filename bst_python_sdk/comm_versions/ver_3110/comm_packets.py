...
class TelemetrySystem:
	...
	def __init__ (self, batt_voltage = 0.0, batt_current = 0.0,
	batt_coulomb_count = 0.0, batt_percent = 0.0, flight_time = 0.0, hour = 0,
	minute = 0, seconds = 0.0, satellites = 0, pdop = 0.0, rssi = 0,
