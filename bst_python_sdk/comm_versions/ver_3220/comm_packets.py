...
class HardwareErrors (Enum):
	...
	HW_ERROR_PIN_RESET=7
	HW_ERROR_POWER_ON_RESET=8
	HW_ERROR_BROWNOUT_RESET=9
	HW_ERROR_SOFTWARE_RESET=10
	HW_ERROR_INDEP_WATCHDOG_RESET=11
	HW_ERROR_LOW_POWER_RESET=12
