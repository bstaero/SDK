...
typedef enum {
	...
	HW_ERROR_PIN_RESET,
	HW_ERROR_POWER_ON_RESET,
	HW_ERROR_BROWNOUT_RESET,
	HW_ERROR_SOFTWARE_RESET,
	HW_ERROR_INDEP_WATCHDOG_RESET,
	HW_ERROR_LOW_POWER_RESET,
...
typedef enum {
	ERROR_NO_ERROR=0L,
	ERROR_LOW_BATT=1L,
	ERROR_HIGH_VOLTAGE=2L,
	ERROR_NO_BATT=4L,
	ERROR_NO_GPS=8L,
	ERROR_NO_RADIO=16L,
	ERROR_HIGH_CURRENT=32L,
	ERROR_HIGH_TEMP=64L,
	ERROR_ENGINE_OUT=128L,
	ERROR_NAVIGATION_ERROR=256L,
	ERROR_CONTROLLER_ERROR=512L,
	ERROR_BAD_IAS=1024L,
	ERROR_FLYING_NO_PREFLIGHT=2048L,
	ERROR_NO_PAYLOAD_ACTUATOR=4096L,
	ERROR_BAD_FLIGHTPLAN=8192L,
	ERROR_NO_SD_CARD=16384L,
	ERROR_SD_CARD_ERROR=32768L,
	ERROR_GEOFENCE=65536L,
	ERROR_BAD_GPS=131072L,
	ERROR_NO_LASER=262144L,
	ERROR_NO_STATIC_PRESS=524288L,
	ERROR_NO_MAG=1048576L,
	ERROR_COMM_LIMIT=2097152L,
	ERROR_BAD_COMMS=4194304L,
	ERROR_BAD_HANDSET=8388608L,
	ERROR_BATT_LIMIT=16777216L,
	ERROR_CRITICAL_BATT=33554432L,
	ERROR_HW_FAULT=67108864L,
	ERROR_BAD_PROPULSION=134217728L,
	ERROR_ICING=268435456L,
	ERROR_BAD_LAUNCH=536870912L,
	ERROR_RESET_IN_FLIGHT=1073741824L,
	ERROR_REMOTE_ID=2147483648L,
