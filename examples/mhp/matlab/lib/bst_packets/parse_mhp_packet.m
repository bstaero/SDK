...
mhp.wind(3) = double(typecast(uint8(data(ptr:ptr+3)),'single')); ptr = ptr+4;
mhp.quaternion(1) = double(typecast(uint8(data(ptr:ptr+3)),'single')); ptr = ptr+4;
mhp.quaternion(2) = double(typecast(uint8(data(ptr:ptr+3)),'single')); ptr = ptr+4;
mhp.quaternion(3) = double(typecast(uint8(data(ptr:ptr+3)),'single')); ptr = ptr+4;
mhp.quaternion(4) = double(typecast(uint8(data(ptr:ptr+3)),'single'));
